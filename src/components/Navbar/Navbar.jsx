...
import { Menu, DropdownLinks } from "./NavbarConstants"
            ...
            <div className="flex justify-center">
                <ul className="sm:flex hidden items-center gap-4">
                    ...
                    <li className="group relative cursor-pointer">
                        ...
                        <div className="absolute z-[999] hidden group-hover:block w-[150px] rounded-md dark:text-white dark:bg-gray-900 bg-white p-2 text-black shadow-md">
                            <ul>
                                {DropdownLinks.map((links) => (
                                    <li key={links.id}><a href={links.link}
